...
impl From<ffi::Vector2> for cgmath::Vector2 {
    fn from(v: ffi::Vector2) -> cgmath::Vector2 {
...
pub fn rquat<T1: AsF32, T2: AsF32, T3: AsF32, T4: AsF32>(x: T1, y: T2, z: T3, w: T4) -> Quaternion {
    cgmath::Quaternion::new(x.as_f32(), y.as_f32(), z.as_f32(), w.as_f32())
}
